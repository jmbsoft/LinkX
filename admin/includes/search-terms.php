...
function deleteAll()
{
    ...
    {
        infoBarAjax({data: 'r=lxSearchTermDelete&term_id=ALL'});
    }
...
function deleteSelected(id)
{
    ...
    {
        infoBarAjax({data: 'r=lxSearchTermDelete&' + selected.serialize()});
    }
...
<div id="main-content">
  <div id="centered-content" class="max-width">
    ...
    <input type="hidden" name="r" value="lxSearchTermSearch">
