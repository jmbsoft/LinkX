...
function mailSelected()
{
    ...
    return {href: 'index.php?&r=lxShMailAdministrator&' + selected.serialize()};
}
...
function deleteSelected(id)
{
    ...
    {
        infoBarAjax({data: 'r=lxDeleteAdministrator&' + selected.serialize()});
    }
  ...
  <div id="centered-content" class="max-width">
    <div class="heading">
      <div class="heading-icon">
        <a href="index.php?r=lxShAddAdministrator" class="window {title: 'Add Administrator'}">
    ...
    <input type="hidden" name="r" value="lxShSearchAdministrators">
