<tr id="<?php echo $item['config_id']; ?>">
  ...
  <td style="text-align: right;" class="last">
       <a href="index.php?r=lxShScannerResults&config_id=<?php echo urlencode($item['config_id']); ?>">
    ...
    <a href="index.php?r=lxShEditScannerConfig&config_id=<?php echo urlencode($item['config_id']); ?>" class="window function {title: 'Edit Scanner Configuration'}">
