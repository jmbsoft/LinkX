...
function deleteSelected(id)
{
    ...
    {
        infoBarAjax({data: 'r=lxDeleteRejection&' + selected.serialize()});
    }
  ...
  <div id="centered-content" class="max-width">
    <div class="heading">
      <div class="heading-icon">
        <a href="index.php?r=lxShAddRejection" class="window {title: 'Add Rejection E-mail'}"><img src="images/add.png" border="0" alt="Add Rejection" title="Add Rejection"></a>
        &nbsp;
    ...
    <input type="hidden" name="r" value="lxShSearchRejections">
