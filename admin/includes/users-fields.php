...
function deleteSelected(id)
{
    ...
    {
        infoBarAjax({data: 'r=lxDeleteUserField&' + selected.serialize()});
    }
  ...
  <div id="centered-content" class="max-width">
    ...
    <div class="heading margin-bottom">
      <div class="heading-icon">
        <a href="index.php?r=lxShAddUserField" class="window {title: 'Add Account Field'}"><img src="images/add.png" border="0" alt="Add Account Field" title="Add Account Field"></a>
        &nbsp;
        <a href="docs/user-fields.html" target="_blank"><img src="images/help.png" border="0" alt="Help" title="Help"></a>
      </div>
      User Defined Account Fields
    </div>
    ...
    <input type="hidden" name="r" value="lxShSearchUserFields">
      ...
      <thead>
        ...
        <tr id="_none_" style="display: none;">
          <td colspan="8" class="last warn">
            No user defined account fields match your search criteria
          </td>
        </tr>
