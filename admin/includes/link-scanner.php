...
function deleteSelected(id)
{
    ...
    {
        infoBarAjax({data: 'r=lxDeleteScannerConfig&' + selected.serialize()});
    }
...
function scannerAction(action, id)
{
    ...
    {
        var func = (action == 'start' ? 'lxScannerStart' : 'lxScannerStop');
  ...
  <div id="centered-content" class="max-width">
    <div class="heading">
      <div class="heading-icon">
        <a href="index.php?r=lxShAddScannerConfig" class="window {title: 'Add Scanner Configuration'}">
      ...
      Link Scanner Configurations
    </div>

    <?php if( !$C['allow_exec'] || empty($C['php_cli']) ): ?>
    ...
    <input type="hidden" name="r" value="lxShSearchScannerConfigs">
      ...
      <thead>
        ...
        <tr id="_none_" style="display: none;">
          <td colspan="7" class="last warn">
            No link scanner configurations have been created
          </td>
        </tr>
