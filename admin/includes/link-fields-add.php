...
<div style="padding: 10px;">
    ...
    <div class="margin-bottom">
      <div style="float: right;">
        <a href="docs/link-fields.html" target="_blank"><img src="images/help.png" border="0" alt="Help" title="Help"></a>
      </div>
      <?php if( $editing ): ?>
      Update this link field by making changes to the information below
      <?php else: ?>
      Add a new link field by filling out the information below
      <?php endif; ?>
    </div>
        ...
        <div class="fieldgroup">
            ...
            <label for="on_submit" class="cblabel"><?php echo CheckBox('on_submit', 'checkbox', 1, $_REQUEST['on_submit']); ?> Display on link submission form</label>
            <label for="on_edit" class="cblabel"><?php echo CheckBox('on_edit', 'checkbox', 1, $_REQUEST['on_edit']); ?> Display on link editing form</label>
            <label for="on_details" class="cblabel"><?php echo CheckBox('on_details', 'checkbox', 1, $_REQUEST['on_details']); ?> Display on site details page</label>
            <label for="required" class="cblabel"><?php echo CheckBox('required', 'checkbox', 1, $_REQUEST['required']); ?> Field is required for submission</label>
            </div>
        </div>
    ...
    <div class="centered margin-top">
      <button type="submit"><?php echo ($editing ? 'Update' : 'Add'); ?> Link Field</button>
    </div>

    <input type="hidden" name="field_id" value="<?php echo $_REQUEST['field_id']; ?>" />
    <input type="hidden" name="r" value="<?php echo ($editing ? 'lxEditLinkField' : 'lxAddLinkField'); ?>">
