<tr id="<?PHP echo $item['field_id']; ?>">
  ...
  <td style="text-align: center;">
    <img src="images/<?PHP echo $item['on_details'] ? 'check' : 'x'; ?>.png">
  </td>
  <td style="text-align: right;" class="last">
    <a href="index.php?r=lxShEditLinkField&field_id=<?php echo urlencode($item['field_id']); ?>" class="window function {title: 'Edit Link Field'}">
