...
function checkForm()
{
    if( $('#r').val() == 'lxSaveDirectoryTemplate' )
    {
  ...
  <div id="centered-content" class="max-width">
    <div class="heading">
      <div class="heading-icon">
        <a href="docs/templates-directory.html" target="_blank"><img src="images/help.png" border="0" alt="Help" title="Help"></a>
      </div>
      Directory Templates
    </div>
    ...
    <div class="centered margin-top" style="font-weight: bold">
      ...
      &nbsp;
      <button type="submit" onclick="$('#r').val('lxLoadDirectoryTemplate')">Load Template</button>
    </div>
    ...
    <div class="centered margin-top" style="font-weight: bold">
    <button type="submit" onclick="$('#r').val('lxSaveDirectoryTemplate')">Save Template</button>
