...
$type_options = array('submit_ip' => 'Submitter IP',
...
<div style="padding: 10px;">
      ...
      <?php endif; ?>
        ...
        <div class="fieldgroup">
            ...
            <select name="type" id="type">
              <?php echo OptionTags($GLOBALS['BLIST_TYPES'], $_REQUEST['type']); ?>
            </select>
        </div>
    ...
    <input type="hidden" name="r" value="<?php echo ($editing ? 'lxEditBlacklist' : 'lxAddBlacklist'); ?>">
