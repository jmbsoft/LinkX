...
function deleteSelected(id)
{
    ...
    {
        infoBarAjax({data: 'r=lxDeleteLinkField&' + selected.serialize()});
    }
  ...
  <div id="centered-content" class="max-width">
    ...
    <div class="heading margin-bottom">
      <div class="heading-icon">
        <a href="index.php?r=lxShAddLinkField" class="window {title: 'Add Link Field'}"><img src="images/add.png" border="0" alt="Add Link Field" title="Add Link Field"></a>
        &nbsp;
        <a href="docs/link-fields.html" target="_blank"><img src="images/help.png" border="0" alt="Help" title="Help"></a>
      </div>
      User Defined Link Fields
    </div>
    ...
    <input type="hidden" name="r" value="lxShSearchLinkFields">
    ...
    <table class="list" cellspacing="0">
      <thead>
        <tr>
          ...
          <td class="last" style="width: 50px">
            Functions
          </td>
        </tr>
      </thead>
        ...
        <tr id="_none_" style="display: none;">
          <td colspan="9" class="last warn">
            No user defined link fields match your search criteria
          </td>
        </tr>
